...
const Planning = ({ calendar }) => {
  ...
  if(!calendar) return <div>Vous n'avez pas les autorisations nécessaires pour voir ce calendrier.</div>
...
export async function getServerSideProps(context) {
  ...
  if([...owner, ...editors, ...readers].indexOf(user._id) === -1) return {props: {calendar: null}}
