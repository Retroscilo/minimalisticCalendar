  ...
  switch (method) {
    ...
    case "DELETE" :
      try {
        ...
        const calendar = Calendar.findById(calendarId)
...
const removeObjectFromArray = (array, objectToRemove) => {
  const newArray = array.filter(object => JSON.stringify(object) === JSON.stringify(objectToRemove))
}
